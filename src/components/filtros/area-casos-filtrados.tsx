...
export default function AreaCasosFiltrados({ casos }: Props) {
  ...
  const filtrados = useMemo(() => {
    return casos.filter((caso) => {
      const texto = `${caso.cliente} ${caso.proyecto} ${caso.id}`.toLowerCase();
  ...
  return (
    <div className="space-y-6">
      <section className="rounded-2xl border border-slate-800 bg-slate-900 p-4 shadow-sm">
        <div className="mb-3">
          <h2 className="text-sm font-semibold text-slate-100">Filtros del área</h2>
          <p className="mt-1 text-xs text-slate-400">
            Explora los casos de esta macroárea por señales operativas
          </p>
        </div>
        ...
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
          <div>
            ...
            <input
              ...
              placeholder="Cliente, proyecto o caso"
      ...
      <section className="rounded-2xl border border-slate-800 bg-slate-900 shadow-sm">
        <div className="border-b border-slate-800 px-6 py-4">
          <h2 className="text-lg font-semibold text-slate-100">Casos del área</h2>
          <p className="mt-1 text-sm text-slate-400">
            Lista priorizada por riesgo y filtros
          </p>
        </div>
